        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('requests.store') }}">
                    ...
                    <!-- Category Selection -->
                    <div class="mb-4">
                        <label for="category_id" class="block text-sm font-medium text-gray-700">Support Category</label>
                    ...
                    <div class="flex items-center justify-end mt-4">
                        <a href="{{ route('requests.index') }}" class="text-gray-600 hover:text-gray-900 mr-4 text-sm">Cancel</a>
